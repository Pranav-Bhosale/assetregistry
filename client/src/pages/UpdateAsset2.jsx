      ...
      >
        <Row style={{ paddingBottom: "10px" }}>
          <Form.Group as={Col} md="6" controlId="validationCustom01">
            ...
            <Form.Control required type="number" placeholder="UID" />
          </Form.Group>
          <Form.Group as={Col} md="6" controlId="validationCustom02">
            <Form.Label>Asset Number</Form.Label>
            <Form.Control required type="text" placeholder="Asset Number" />
          </Form.Group>
        </Row>
        ...
        <Row style={{ paddingBottom: "10px" }}>
          <Col md="6" style={{ padding: 0, margin: 0 }}>
            <Form.Group as={Col} md="12" controlId="validationCustom02">
              ...
              <Form.Control required type="text" placeholder="Make" />
            </Form.Group>
          </Col>
          <Col md="6" style={{ padding: 0, margin: 0 }}>
          ...
          <Col md="6" style={{ padding: 0, margin: 0 }}>
            <Row style={{ padding: 0, margin: 0 }}>
              ...
              <Form.Group as={Col} controlId="validationCustom02">
                ...
                <Form.Control required type="number" placeholder="Warranty" />
              </Form.Group>
            </Row>
          </Col>
        </Row>
          ...
          <Col md="6" style={{ padding: 0, margin: 0 }}>
            <Row style={{ padding: 0, margin: 0 }}>
              <Form.Group as={Col} controlId="validationCustom02">
                ...
                <Form.Control required type="number" placeholder="Total Cost" />
              </Form.Group>
        ...
        <Row style={{ paddingBottom: "10px" }}>
          <Form.Group as={Col} md="6" controlId="validationCustom02">
            ...
            <Form.Control required type="text" placeholder="Remark" />
          </Form.Group>
          <Form.Group as={Col} md="6" controlId="validationCustom01">
            <Form.Label>Part</Form.Label>
            <Form.Control required type="Text" placeholder="Part" />
          </Form.Group>
        </Row>
        <hr className="hrline" />
        <br />
